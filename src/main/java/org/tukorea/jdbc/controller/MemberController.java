...
public class MemberController {
	...
	public String updateMemberGet(@RequestParam("id") String id, Model model) throws Exception {
	    StudentVO student = memberService.readMember(id);
	    model.addAttribute("student", student);
	...
	public String updateMemberPost(@ModelAttribute("student") StudentVO vo) throws Exception {
